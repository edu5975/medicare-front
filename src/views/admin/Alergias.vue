...
export default {
    ...
    created(){
        ...
        axios({
            method: 'get',
            url: 'https://proyecto-tweb.herokuapp.com/alergias'
            })
        .then(response=>{
    ...
    methods: {
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {                        
                        axios({
                            method: 'delete',
                            url: 'https://proyecto-tweb.herokuapp.com/alergias/'+id
                            })
                        .then(response=>{
                            funciones.iniciar();
                        })
        ...
        registro:function(descripcion="",id=0){
            ...
            $.confirm({
                ...
                '<form action="" class="formName">' +
                    ...
                    '<label>Ingrese el nombre de la alergia</label>' +
        ...
        editar:function(data){
            ...
            axios({
                method: 'put',
                url: 'https://proyecto-tweb.herokuapp.com/alergias/'+data.id,
                data
                })
            .then(response=>{
                this.iniciar();
