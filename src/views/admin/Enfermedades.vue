...
export default {
    ...
    created(){
        ...
        axios({
            method: 'get',
            url: 'https://proyecto-tweb.herokuapp.com/enfermedades'
            })
        .then(response=>{
    ...
    methods: {
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {                        
                        axios({
                            method: 'delete',
                            url: 'https://proyecto-tweb.herokuapp.com/enfermedades/'+id
                            })
                        .then(response=>{
        ...
        registro:function(descripcion="",id=0){
            ...
            $.confirm({
                ...
                '<form action="" class="formName">' +
                    ...
                    '<label>Ingrese el nombre de la enfermedad</label>' +
        ...
        editar:function(data){
            ...
            axios({
                method: 'put',
                url: 'https://proyecto-tweb.herokuapp.com/enfermedades/'+data.id,
                data
                })
            .then(response=>{
                this.iniciar();
